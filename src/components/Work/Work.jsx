...
function Work() {
  ...
  return (
    <section
      id="work"
      className="py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans realative"
    >
      {/* section title  */}
          ...
          <div className="bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl overflow-hidden relative">
            ...
            <div className="flex flex-col">
              <div className="w-full flex justify-center bg-gray-900 px-4">
                <img src={selectProject.img} alt={selectProject.title} className="lg:w-full w-[95%] object-contain rounded-xl shadow-2xl" />
              </div>
              <div className="lg:p-8 p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {selectProject.tags.map((tags, index) => (
                    <span
                      key={index}
                      className="bg-[#251f38] texxt-xs font-semibold text-purple-500 rounded-full px-2 py-1">
                      {tags}
                    </span>
                ...
                <div className="flex gap-4">
                  ...
                  <a href={selectProject.live} target="_blank" rel="noopener noreferrer"
